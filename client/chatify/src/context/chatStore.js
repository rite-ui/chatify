...
const useChatStore = create((set, get) => ({
  conversations: [
    { _id: "conv_1", name: "Aman", type: "dm", participants: [{ _id: "ME", username: "Ritesh Dev" }, { _id: "user_1", username: "Aman", status: "online" }], lastMessage: { content: "Hello bro, design system kaisa laga?" }, updatedAt: new Date() },
    { _id: "conv_2", name: "Dev Group", type: "group", participants: [{ _id: "ME" }, { _id: "user_2" }, { _id: "user_3" }], lastMessage: { content: "React 19 aur Tailwind v4 rock! 🚀" }, updatedAt: new Date() }
  ],
  ...
  setActiveConversation: (conv) => {
    ...
    if (conv && !get().messages[conv._id]) {
      set((s) => ({ messages: { ...s.messages, [conv._id]: [] } }));
    }
  },

  // ✅ Hooks ke liye required functions mapping:
  addMessage: (msg) => {
