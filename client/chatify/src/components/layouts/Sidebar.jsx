...
const Sidebar = ({ activeConversation, setActiveConversation }) => {
  ...
  // Dummy Conversations Data (Exactly unhi keys ke sath jo database me hoti hain)
  const conversations = [
    ...
    <>
      <div className='w-75 lg:w-80 flex flex-col border-r border-(--border) bg-(--bg-card) shrink-0 h-full shadow-(--shadow)'>
        ...
        <div className='px-4 py-4 border-b border-(--border)'>
          ...
          {/* SEARCH BAR (Uses custom utility from index.css) */}
        ...
        <div className='flex-1 overflow-y-auto py-2 px-2 space-y-1'>
          {loading ? (
            /* SKELETON LOADER (Jab page refresh hota hai) */
            ...
            /* EMPTY STATE (Jab search me kuch match na kare) */
